<nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item <?php echo ($this->router->fetch_class() == "Dashboard" && ($this->router->fetch_method() == "index")) ? "active" : ""; ?>">
                ...
                </li><li class="sidebar-item <?php echo ($this->router->fetch_class() == "HomeSlider" && ($this->router->fetch_method() == "add" || $this->router->fetch_method() == "list")) ? "active" : ""; ?>">
                    ...
                    </li><li class="sidebar-item <?php echo ($this->router->fetch_class() == "Category" && ($this->router->fetch_method() == "add" || $this->router->fetch_method() == "index")) ? "active" : ""; ?>">
                    ...
                    </li><li class="sidebar-item <?php echo ($this->router->fetch_class() == "Product" && ($this->router->fetch_method() == "add" || $this->router->fetch_method() == "index")) ? "active" : ""; ?>">
                    ...
                    </li><li class="sidebar-item <?php echo ($this->router->fetch_class() == "ContactInquiry" && ($this->router->fetch_method() == "inquiryList")) ? "active" : ""; ?>">
                    ...
                    </li><li class="sidebar-item <?php echo ($this->router->fetch_class() == "SiteSetting" && ($this->router->fetch_method() == "siteSetting")) ? "active" : ""; ?>">
